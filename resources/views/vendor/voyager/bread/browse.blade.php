                                ...
                                @foreach($dataTypeContent as $data)
                                    <tr>
                                        ...
                                        <td class="no-sort no-click bread-actions">
                                            @foreach($actions as $action)
                                                @if (!method_exists($action, 'massAction'))
                                                    @if($data instanceof \App\Gx\GrowLog)
                                                        @include('voyager::grow-logs.actions', ['action' => $action])
                                                    @elseif($data instanceof \App\Models\Chat)
                                                        @include('voyager::chats.actions', ['action' => $action])
                                                    @else
