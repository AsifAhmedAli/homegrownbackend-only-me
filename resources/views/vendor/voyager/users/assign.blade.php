        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="panel panel-bordered">
                    <!-- form start -->
                    <form role="form" class="form-edit-add" action="{{ route('admin.user.post.assign', ['user' => $user->id]) }}" method="POST" enctype="multipart/form-data" novalidate="novalidate">
                        @csrf
                        <div class="panel-body">
                            ...
                            <div class="form-group  col-md-12 ">
                                ...
                                <x-dropdown.grow-operator
                                        ...
                                        :value-name="optional($user->assignee)->name"
                                />
                            </div>
                        </div>
