        ...
        <td>
            ...
            @include('emails.includes.header_section')
                ...
                <!-- Content sec starts here -->
                 <tr>
                    <td align="left" valign="middle" style="font-size: 25px; font-weight: 700; color:#000000;">Forgot Something?</td>
                 </tr>
                ...
                <tr>
                    <td align="left" valign="middle">
                        <a href="{{ $user['link'] }}" style="font-size: 18px; font-weight: 700; color:#333333; background-color: #FFF; border: 2px solid #333333; text-transform: uppercase; text-decoration: none; width: 228px; float: left; text-align: center;padding: 13px 0px;">RESUME YOUR ORDER</a>
                    </td>
                </tr>
