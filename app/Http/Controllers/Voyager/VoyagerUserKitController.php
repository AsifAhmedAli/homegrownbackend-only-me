...
class VoyagerUserKitController extends VoyagerController
{
    public function show(Request $request, $id)
    {
        ...
        $redirection = Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable', 'isSoftDeleted'));
        ...
        if($request->has('tracking_number')) {
            $response = $dataTypeContent->changeTrackingNumber($request->tracking_number);
            if($response) {
                $redirection = redirect()->back()->with([
                    'alert-type' => 'success',
