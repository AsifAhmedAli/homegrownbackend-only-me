                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="650" align="center" style="border-collapse: collapse;
                            ...
                            <tr>
                                <td align="left" valign="middle" style="font-size: 16px; font-weight: 400; color:#000000; line-height: 1.5;">
                                    <p>There is a new Open Support Ticket having {{ ucwords($ticket->priority) }} Priority</p>
                                    <p>Ticket ID is #{{ $ticket->ticket_number }}</p>
                                    <p>
                                        {{ $ticketMessage->message }}
                                    </p>
                                    <p><a href="{{ url('/admin/ticket-messages/create?ticket=' . $ticket->id) }}">View Ticket</a></p>
                                </td>
                            </tr>
